...
// TODO: getting an error when using dev build on iOS 8.1 when testing for mq.
		...
		if (isProduction) {
			return gulp
				.src([
					...
					'!' + config.srcPath + '/js/libraries/**',
					'!' + config.srcPath + '/js/vendor/**',
			...
			return gulp
				// Pointing at the gulpfile instead of leaving empty/blank
				// Temporary placeholder because there was an issue in the past
				.src('gulpfile.js')
