...
import newPlayer from './classes/player';
...
$(document).ready(function () {
	...
	$('.slot').mousedown(function (e) {
		if (e.button === 2) {
			console.log('slot right clicked');
	...
	$('.spellbar').mousedown(function (e) {
		if (e.button === 2) {
			console.log('spellbar right clicked');
			clickeditemid = this.id;
			$('#showdiv').css({ display: 'none' });
			$('#showdiv1').css({ display: 'none' });
	...
	function sellall() {
		for (let i = 1; i < 29; i++) {
			...
			if (!inventory[sellitemid]) return;
	...
	$('#combat-map-arrow').click(() => {
		console.log('combat-map-arrow');
		$('#screen__map').addClass('is-open');
	});

	$('#combat-back-arrow').click(() => {
		console.log('combat-back-arrow');
		$('#screen__town').addClass('is-open');
	});

	$('#screen__map').click(() => {
		$('#screen__map').removeClass('is-open');
	});

	$('#screen__town').click(() => {
		$('#screen__town').removeClass('is-open');
	});
